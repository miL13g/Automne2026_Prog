...
1. `croquettes / chats` 5.88235294 **float**
2. `croquettes // chats` 5 **int**
3. `croquettes % chats` 15 **int**
4. `chats ** 2` 289 **int**
5. `chats % 2` 1 **int**
...
1. `siestes + souris * boules_de_poils` 27
2. `(siestes + souris) * boules_de_poils` 51
3. `siestes // souris ** 2` 0
4. `siestes % souris * boules_de_poils` 6
5. `-siestes // souris` ⚠️ (piège!) -3
